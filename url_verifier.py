...
urls_to_test = [
    ...
    "https://en.wikipedia.org/wiki/Meat_%26_Potatoes",
    "https://en.wikipedia.org/wiki/Primanti_Brothers",
    "https://en.wikipedia.org/wiki/Klavon%27s_Ice_Cream_Parlor",
    "https://en.wikipedia.org/wiki/Vincent%27s_Pizza_Park",
    "https://en.wikipedia.org/wiki/Trey_Cafe",
    "https://en.wikipedia.org/wiki/Eat%27n_Park",
    "https://en.wikipedia.org/wiki/Hoss%27s_Steak_and_Sea_House",
    "https://en.wikipedia.org/wiki/Atria%27s",
    "https://en.wikipedia.org/wiki/Mad_Mex",
    "https://en.wikipedia.org/wiki/Pirmanti_Brothers",
    "https://en.wikipedia.org/wiki/Max%27s_Allegheny_Tavern",
    "https://en.wikipedia.org/wiki/Conflict_Kitchen",
    "https://en.wikipedia.org/wiki/Original_Hot_Dog_Shop",

    # 50 General Pittsburgh
    ...
    "https://en.wikipedia.org/wiki/Climate_of_Pittsburgh",
